...
**Theme:** Dark `#10141A` background · Blue `#6E93E8` accents · White `#E8EBEF` text · Geist Sans + Geist Mono  
...
**Screenshot tips:**
- Use dark terminal (e.g., Warp, iTerm with `#10141A` bg)
...
Regenerate after blue rebrand:
```bash
cd warden-landing/product-hunt-gallery
# Update styles.css: --accent to #6E93E8, --bg to #10141A
node render.cjs
ls output/*.png
```
...
- [ ] Dark blacks are `#10141A`, not `#000000` (true black looks cheap)
- [ ] Blue is exactly `#6E93E8` (check with eyedropper)
- [ ] Text is Geist Sans / Geist Mono, not AI-generated text
