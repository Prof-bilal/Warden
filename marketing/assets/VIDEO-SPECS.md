...
**Theme:** Dark `#10141A` · Blue `#6E93E8` · Burned-in captions (most platforms autoplay muted)  
...
**Burned-in specs:**
- Font: Geist Sans Bold, white `#E8EBEF` with `#10141A` outline (2px stroke)
- Position: bottom 15% safe area, centered, max 2 lines, 32px on 1080×1920
- Word-level highlight: current word in `#6E93E8` (optional, for kinetic reels)
...
|---|---|---|---|
| YouTube | `1280×720` | `Your MCP servers don't need your whole filesystem` | Dark `#10141A` + blue shield accent |
| LinkedIn | `1200×627` | Same | Same |
| X | `1200×675` | Same | Same |

**Thumbnail prompt (AI):**
```
YouTube thumbnail, dark near-black (#10141A) background, large bold white text "Your MCP servers don't need your whole filesystem" in Geist Sans Bold, small blue (#6E93E8) geometric shield icon in corner, minimal tech style, no faces, no stock, 1280x720, high contrast
```
