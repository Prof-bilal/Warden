...
**Visual:** Dark `#10141A` bg, large blue shield icon (200×200) centered top, white headline below.  
**Text:**
```
YOUR MCP SERVERS
CAN READ EVERYTHING.

[Small blue line below, 60px wide, 3px thick, centered]
```

**Font:** Geist Sans Bold, 48px, `#E8EBEF`, line-height 1.1, centered. Blue line: `#6E93E8`.
...
**Font:** Geist Sans Regular, 28px, `#E8EBEF` for headings, `#8D95A5` for body.
...
**Font:** Headline Geist Sans Bold 32px `#E8EBEF`, bullets Geist Sans Regular 24px `#8D95A5`, blue dots `#6E93E8`.
...
**Font:** Geist Mono, 20px, `#E8EBEF` for paths, `#8D95A5` for arrows, blue `#6E93E8` for `READ`/`CONNECT`. Last line Geist Sans Bold 24px `#6E93E8`.
...
**Font:** Headline Geist Sans Bold 36px `#E8EBEF`, CTA Geist Sans Bold 20px `#6E93E8`, link Geist Sans Regular 16px `#8D95A5`.
...
**Visual:** Code card: `policy.yaml` with filesystem/network/env blocks, blue highlight on each block. Background `#171C24`, border `#1E242E`, Geist Mono.  
**Text:**
```
...
**Visual:** Terminal card: `warden run --policy policy.yaml -- node server.js` with green `✓` output. Dark terminal, Geist Mono.  
**Text:**
```
...
**Font:** Geist Mono 18px, green `#3FB27E` for `✓`, muted `#8D95A5` for `✗`.
...
**Cover frame:** `1080×1920` — Dark bg, blue shield, white headline `YOUR MCP SERVERS CAN READ EVERYTHING` (Geist Sans Bold, 48px). This is what shows in grid.
...
|---|---|---|---|
| Carousel 1 (6 slides) | `warden-carousel-problem-01` … `06-1080x1080.png` | 1080×1080 ×6 | Figma: dark/blue, Geist Sans + Geist Mono |
